...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"第一頁",sLast:"最後一頁",sNext:"下一頁",sPrevious:"上一頁"},sEmptyTable:"目前還沒有日記",sInfo:"正在顯示 _START_ 到 _END_ 筆日記，共 _TOTAL_ 筆日記",sInfoEmpty:"正在顯示 0 到 0 筆日記，共 0 筆日記",
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"每頁 _MENU_ 筆日記",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"搜尋",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
